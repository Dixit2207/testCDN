...
describe('ail-datepicker-navigation-select', () => {

    beforeEach(() => {
        TestBed.overrideModule(AilDatepickerModule, { set: { exports: [AilDatepickerNavigationSelect] } });
    ...
    it('should generate month options correctly', () => {
        const fixture =
            createTestComponent('<ail-datepicker-navigation-select [locale]="\'en\'" [date]="date" [months]="months" [years]="years">');
    ...
    it('should send date selection events', () => {
        const fixture = createTestComponent(
            '<ail-datepicker-navigation-select [locale]="\'en\'" [date]="date" [months]="months" [years]="years" (select)="onSelect($event)">');
        ...
        expect(fixture.componentInstance.onSelect).toHaveBeenCalledWith(new AilDate(2016, 10, 1));

        changeSelect(yearSelect, '2017');
        expect(fixture.componentInstance.onSelect).toHaveBeenCalledWith(new AilDate(2017, 8, 1));

        // out of range
        changeSelect(yearSelect, '2000');
        // expect(fixture.componentInstance.onSelect).toHaveBeenCalledWith(new AilDate(NaN, 8, 1));
    });
    ...
    it('should have disabled select boxes when disabled', () => {
        const fixture = createTestComponent(
            '<ail-datepicker-navigation-select [locale]="\'en\'" [disabled]="true" [date]="date" [months]="months" [years]="years">');
    ...
    it('should have correct aria attributes on select options', () => {
        const fixture =
            createTestComponent('<ail-datepicker-navigation-select [locale]="\'en\'" [date]="date" [months]="[7, 8, 9]" [years]="years">');
