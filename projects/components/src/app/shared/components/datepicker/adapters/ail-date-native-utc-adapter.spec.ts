import { AilDateNativeUTCAdapter } from './ail-date-native-utc-adapter';

describe('ail-date-native-utc model adapter', () => {
    let adapter: AilDateNativeUTCAdapter;

    beforeEach(() => {
        adapter = new AilDateNativeUTCAdapter();
    });
