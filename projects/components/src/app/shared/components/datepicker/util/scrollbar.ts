...
export class ScrollBar {
    constructor(@Inject(DOCUMENT) private _document: any, private window: Window) {
    }
    ...
    private _adjustBody(scrollbarWidth: number): CompensationReverter {
        ...
        const actualPadding = parseFloat(this.window.getComputedStyle(body)['padding-right']);
    ...
    private _isPresent(scrollbarWidth: number): boolean {
        ...
        const bodyToViewportGap = this.window.innerWidth - (rect.left + rect.right);
